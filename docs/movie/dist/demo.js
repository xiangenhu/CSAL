	...
	*/
	      ...
	      events: {
	        ...
	        onReady: function onReady(event) {
	          ...
	          player.media.play = function () {
				...
				if (qs("xAPI","0")=="1"){
					var LCCData={"youtube":qs("MVL",""),
								"MOVIETitle":decodeURI(qs("MVTitle","")),
								"PlayedTime":player.currentTime
					};
					xAPIPost(player.currentTime,"Played","youtube",LCCData)
				}
	          ...
	          player.media.pause = function () {
				if (qs("xAPI","0")=="1"){
					...
					xAPIPost(player.currentTime,"Paused","youtube",LCCData)
				}
	...
	var sources = {
	  ...
	  youtube: {
	    type: 'video',
	    sources: [{
	      src: 'https://youtube.com/watch?v='+qs('MVL','bTqVqk7FSmY'),
	      provider: 'youtube'
	    }]
	  },
	  vimeo: {
	    type: 'video',
	    sources: [{
	      src: 'https://vimeo.com/'+qs('MVL','40648169'),
	      provider: 'vimeo'
	    }]
	  }
	};
