	...
	var lessonName;
        ...
        URLParams = URI.parseQuery(window.location.search);
			if (URLParams["lessonName"] != undefined) {
				...
				s += '</td>';
				s += '<td width="100" align="center">';
				s += '<div id="Movie2" style="width:130px; height:110px">';
				s += '<td width="15" align="center"><div><img src="imgs/off.png" onClick="vioceOn()" style="cursor:pointer;" id="On" ></div>';
				s += '</td>';
				s += '</tr>';
				s += '</table>';
...
Speak("Movie2", C25);
				Speak("Movie1", "Voice on");
				Speak("Movie3", "Voice on");
			$('#On').hide();
