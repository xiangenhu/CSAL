...
//alert("Call get mediafeedback:"+getValue);
	if (getValue=="Instruction")
	{
		...
		playSentence=qa0;
		var Feedback="ComputerTutor:Speak:"+playSentence;
		return Feedback;
	...
	else if(getValue=="TAGoodAnswer")
	{
		...
		var Feedback="ComputerTutor:Speak:"+TutorGoodAnswer;
		return Feedback;
	}
	...
	var JordanSentence="";
		...
		var Feedback="ComputerStudent1:Speak:"+JordanSentence;
		JordanScore++;
		return Feedback;
