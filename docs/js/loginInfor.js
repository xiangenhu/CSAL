...
var whynameurl=GoogleSplidesCommon1+
		 qs("whynameurl","2PACX-1vT3yLczIJ2PYA0NYrtlGWOyyZIAaimDAcMXVszxOUGBrSFycqIn1rbHM_HJ8hor1Cl8U0KC8VxJX5iY")
		 +GoogleSplidesCommon2;
		 
var whoweareusurl=GoogleSplidesCommon1+
		 qs("whoweareusurl","2PACX-1vRItjUTN3b1KhxtxpVYWEjNEVRzL7rLHK_qS5rEPa3m02FLd45uFwjenUmVolB5HAhU__PiCo4aR7_0")
		 +GoogleSplidesCommon2;
var WhatisAutoTutorURL=GoogleSplidesCommon1+
		 qs("WhatisAutoTutorURL","2PACX-1vTz-LA4ZoAezGWvT19wpafaaLLf7bmPVyMhHbgvT7Sn5yYsDgCHU9X5F_TZ2W0vgPFF1gZMNuWvdsjP")
		 +GoogleSplidesCommon2;
var UsefulLinksURL=GoogleSplidesCommon1+
		 qs("UsefulLinksURL","2PACX-1vTz-LA4ZoAezGWvT19wpafaaLLf7bmPVyMhHbgvT7Sn5yYsDgCHU9X5F_TZ2W0vgPFF1gZMNuWvdsjP")
		 +GoogleSplidesCommon2;
var snapshotURL=GoogleSplidesCommon1+
		 qs("snapshotURL","2PACX-1vR7xgPa4mOrI7j_qti5uyBKUaeNtoT5xdiSaxNVVSfuGSpzj-9HMLM5fQ-aNqnLz9DJue0ZZIiwH8gk")
		 +GoogleSplidesCommon2;

var feedbackURL="https://forms.gle/C33M68S65gujCWSk7";

var RememberEmailURL=GoogleSplidesCommon1+
		 qs("RememberEmailURL","2PACX-1vSTPAqYkkgrrImMxf2uXNeC4wgM105aS49f-E6EimF6_N3km0U5GBnscZUKCkByIHBQHeDd6mm2LfWG")
		 +GoogleSplidesCommon2;
...
if (anApp=="csal"){
	  url="https://ace.autotutor.org/at2017/csal2018.html?"+
	  "LessonName="+qs("LN","lesson6")+"&UID="+youremail+"&SName="+yourname+"&ssid="+qsp("aicc_sid","Missing");
	  return url;
  }else if (anApp=='aries'){
	  AppRoot=qs("appRoot","https://app.skoonline.org/aries/");
	  var urlvariable="guid="+guid+
					  "&SName="+fullname+
	  ...
	  var urlvariable="guid="+guid+
		  "&fullname="+qs("fullname",fullname)+
		  "&user="+qs("user",email)+
		  "&starting="+qs("starting","0")+
		  "&ST="+qs("ST","ID")+
		  "&doOverall1="+doOverall1+
		  "&editing="+AllowEditing+
		  "&connected="+connected+
		  "&SampleGUID="+SampleGUID+
		  "&DEBUGGING="+qs("DEBUGGING","0")+
		  "&tophref="+theHREF+
		  "&TargetUser="+qs("TargetUser","augtest23@gmail.com");
		  url=AppRoot+app+".html?"+urlvariable;
		  return url;
	  ...
	  var urlvariable="guid="+guid+
		  ...
		  "&GL=1"+
		  "&DEBUGGING="+qs("DEBUGGING","0")+
		  "&StartingMovie="+qs("StartingMovie","0")+
		  "&connected="+connected+
		  "&doOverall1="+doOverall1+
		  "&editing="+AllowEditing+
		  "&tophref="+theHREF;
...
if (((email=="")&&(fullname==""))||(fullname=="")){
  ...
  alert("If you don't have an email, you can enter a unique string instead.\n\n Suggested email:  " + fullname.toLowerCase() + "_at"+app+"@"+app+".autotutor.org");
  return;
}
if (qs("remail","1")=="0"){
  ...
  switch(pos) {
	  case -1:
		  ...
		  break;
	  default:
		  email = email.toLowerCase().slice(0,pos)+"@"+app+".autotutor.com";
  } 
}
...
//	    return;
  ...
  Metalink.content = "583287928734-jdsedg4n8cu2m6m664u0tbj2671qpv6s.apps.googleusercontent.com";
