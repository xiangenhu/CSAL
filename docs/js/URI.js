...
(function (p, v) {
  "object" === typeof exports
    ...
    : (p.URI = v(p.punycode, p.IPv6, p.SecondLevelDomains, p));
  ...
  function C(a, b) {
    ...
    else if (h(b)) for (d = 0, g = b.length; d < g; d++) c[b[d]] = !0;
    else c[b] = !0;
    d = 0;
  ...
  for (y in t)
    (d[y + "PathSegment"] = B("pathname", t[y])),
      (d[y + "UrnPathSegment"] = B("urnpath", t[y]));
  t = function (a, b, c) {
    return function (f) {
      var g;
      g = c
  ...
  d.parseQuery = function (a, b) {
    ...
    if (!a) return {};
    for (var c = {}, f = a.split("&"), g = f.length, e, m, n = 0; n < g; n++)
      (e = f[n].split("=")),
        (m = d.decodeQuery(e.shift(), b)),
        (e = e.length ? d.decodeQuery(e.join("="), b) : null),
        q.call(c, m)
          ? ("string" === typeof c[m] && (c[m] = [c[m]]), c[m].push(e))
          : (c[m] = e);
    return c;
  };
  d.build = function (a) {
  ...
  d.buildQuery = function (a, b, c) {
    ...
    for (e in a)
      if (q.call(a, e) && e)
        if (h(a[e]))
          for (g = {}, m = 0, n = a[e].length; m < n; m++)
            void 0 !== a[e][m] &&
              void 0 === g[a[e][m] + ""] &&
              ((f += "&" + d.buildQueryParameter(e, a[e][m], c)),
              !0 !== b && (g[a[e][m] + ""] = !0));
  ...
  d.removeQuery = function (a, b, c) {
    var f;
    if (h(b)) for (c = 0, f = b.length; c < f; c++) a[b[c]] = void 0;
    else if ("RegExp" === w(b)) for (f in a) b.test(f) && (a[f] = void 0);
  ...
  d.withinString = function (a, b, c) {
    ...
    for (f.lastIndex = 0; ; ) {
      ...
      (c.ignore && c.ignore.test(l)) ||
        ((h = n + l.length),
        (l = b(l, n, h, a)),
        (a = a.slice(0, n) + l + a.slice(h)),
        (f.lastIndex = n + l.length));
    }
    f.lastIndex = 0;
    return a;
  };
  d.ensureValidHostname = function (a) {
    if (a.match(d.invalid_hostname_characters)) {
      ...
      if (p.toASCII(a).match(d.invalid_hostname_characters))
        throw new TypeError(
  ...
  d.noConflict = function (a) {
    if (a)
      return (
        ...
        l.URITemplate &&
          "function" === typeof l.URITemplate.noConflict &&
          (a.URITemplate = l.URITemplate.noConflict()),
        l.IPv6 &&
          "function" === typeof l.IPv6.noConflict &&
          (a.IPv6 = l.IPv6.noConflict()),
        l.SecondLevelDomains &&
          "function" === typeof l.SecondLevelDomains.noConflict &&
          (a.SecondLevelDomains = l.SecondLevelDomains.noConflict()),
        a
      );
    l.URI === this && (l.URI = G);
    return this;
  ...
  e.href = function (a, b) {
    ...
    if ("string" === typeof a || a instanceof String)
      ...
      for (c in ((f = f ? a._parts : a), f))
        q.call(this._parts, c) && (this._parts[c] = f[c]);
  ...
  e.is = function (a) {
    ...
    this._parts.hostname &&
      ...
      (b = c || f),
      (k = (e = !b) && u && u.has(this._parts.hostname)),
      (m = e && d.idn_expression.test(this._parts.hostname)),
      (h = e && d.punycode_expression.test(this._parts.hostname)));
  ...
  e.tld = function (a, b) {
    ...
    if (void 0 === a) {
      ...
      return !0 !== b && u && u.list[c.toLowerCase()]
        ? u.get(this._parts.hostname) || c
        : c;
    }
    if (a)
  ...
  e.suffix = function (a, b) {
    ...
    "." === a.charAt(0) && (a = a.substring(1));
    if ((c = this.suffix()))
      f = a ? new RegExp(r(c) + "$") : new RegExp(r("." + c) + "$");
    else {
      if (!a) return this;
  ...
  e.segmentCoded = function (a, b, c) {
    ...
    if (void 0 === b) {
      ...
      if (h(a)) for (e = 0, g = a.length; e < g; e++) a[e] = d.decode(a[e]);
      else a = void 0 !== a ? d.decode(a) : void 0;
      return a;
    }
    if (h(b)) for (e = 0, g = b.length; e < g; e++) b[e] = d.decode(b[e]);
  ...
  e.normalizeHostname = function (a) {
    this._parts.hostname &&
      (this.is("IDN") && p
        ? (this._parts.hostname = p.toASCII(this._parts.hostname))
        : this.is("IPv6") &&
          v &&
  ...
  e.readable = function () {
    ...
    a._parts.hostname &&
      (a.is("punycode") && p
        ? ((b += p.toUnicode(a._parts.hostname)),
    ...
    if (a._parts.query) {
      for (
        var c = "", e = 0, g = a._parts.query.split("&"), k = g.length;
        e < k;
        e++
      ) {
        var h = (g[e] || "").split("="),
