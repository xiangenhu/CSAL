...
(function(p, v) {
    "object" === typeof exports ? module.exports = v(require("./punycode"), require("./IPv6"), require("./SecondLevelDomains")) : "function" === typeof define && define.amd ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], v) : p.URI = v(p.punycode, p.IPv6, p.SecondLevelDomains, p)
})(this, function(p, v, u, l) {
        function d(a, b) {
        ...
        d.defaultPorts = {
            ...
            };d.encode = A;d.decode = decodeURIComponent;d.iso8859 = function() {
                d.encode = escape;
                d.decode = unescape
            };d.unicode = function() {
                d.encode = A;
            ...
            for (y in t) d[y + "PathSegment"] = B("pathname", t[y]),
            d[y + "UrnPathSegment"] = B("urnpath", t[y]);t = function(a, b, c) {
                return function(f) {
                    var g;
                    g = c ? function(a) {
                        return d[b](d[c](a))
                    ...
                    f = (f + "").split(a);
                    for (var e = 0, m = f.length; e < m; e++) f[e] = g(f[e]);
                    return f.join(a)
                }
            };d.decodePath =
            t("/", "decodePathSegment");d.decodeUrnPath = t(":", "decodeUrnPathSegment");d.recodePath = t("/", "encodePathSegment", "decode");d.recodeUrnPath = t(":", "encodeUrnPathSegment", "decode");d.encodeReserved = B("reserved", "encode");d.parse = function(a, b) {
                ...
                var c = a.indexOf("/"),
                    f = a.lastIndexOf("@", -1 < c ? c : a.length - 1); - 1 < f && (-1 === c || f < c) ? (c = a.substring(0, f).split(":"), b.username = c[0] ? d.decode(c[0]) : null, c.shift(), b.password =
                    c[0] ? d.decode(c.join(":")) : null, a = a.substring(f + 1)) : (b.username = null, b.password = null);
                return a
            };d.parseQuery = function(a, b) {
                if (!a) return {};
                a = a.replace(/&+/g, "&").replace(/^\?*&*|&+$/g, "");
                if (!a) return {};
                for (var c = {}, f = a.split("&"), g = f.length, e, m, n = 0; n < g; n++) e = f[n].split("="), m = d.decodeQuery(e.shift(), b), e = e.length ? d.decodeQuery(e.join("="), b) : null, q.call(c, m) ? ("string" === typeof c[m] && (c[m] = [c[m]]), c[m].push(e)) : c[m] = e;
                return c
            };d.build = function(a) {
                var b = "";
            ...
            d.buildUserinfo = function(a) {
                ...
                for (e in a)
                    if (q.call(a, e) && e)
                        if (h(a[e]))
                            for (g = {}, m = 0, n = a[e].length; m < n; m++) void 0 !== a[e][m] && void 0 === g[a[e][m] + ""] && (f += "&" + d.buildQueryParameter(e, a[e][m], c), !0 !== b && (g[a[e][m] + ""] = !0));
                ...
                else if ("string" === typeof b) void 0 !== c ? "RegExp" === w(c) ? !h(a[b]) && c.test(a[b]) ? a[b] = void 0 : a[b] = C(a[b], c) : a[b] === c ? a[b] = void 0 : h(a[b]) && (a[b] = C(a[b], c)) : a[b] = void 0;
                ...
                if ("object" === typeof b) {
                    for (var e in b)
                        if (q.call(b, e) && !d.hasQuery(a, e, b[e])) return !1;
                    return !0
                }
                ...
                switch (w(c)) {
                    case "Undefined":
                        return b in a;
                    case "Boolean":
                        return a = Boolean(h(a[b]) ? a[b].length : a[b]), c === a;
                    case "Function":
                        return !!c(a[b], b, a);
                    case "Array":
                        return h(a[b]) ? (f ? z : D)(a[b], c) : !1;
                    case "RegExp":
                        return h(a[b]) ? f ? z(a[b], c) : !1 : Boolean(a[b] && a[b].match(c));
                    case "Number":
                        c = String(c);
                    case "String":
                ...
                for (f.lastIndex = 0;;) {
                    ...
                    if (c.ignoreHtml) {
                        var h = a.slice(Math.max(n - 3, 0),
                            n);
                        if (h && m.test(h)) continue
                    }
                    var h = n + a.slice(n).search(e),
                        l = a.slice(n, h).replace(k, "");
                    c.ignore && c.ignore.test(l) || (h = n + l.length, l = b(l, n, h, a), a = a.slice(0, n) + l + a.slice(h), f.lastIndex = n + l.length)
                }
                f.lastIndex = 0;
                return a
                ...
                if (a.match(d.invalid_hostname_characters)) {
                    ...
                    if (p.toASCII(a).match(d.invalid_hostname_characters)) throw new TypeError('Hostname "' +
                        a + '" contains characters other than [A-Z0-9.-]');
                }
            };d.noConflict = function(a) {
                if (a) return a = {
                    URI: this.noConflict()
                }, l.URITemplate && "function" === typeof l.URITemplate.noConflict && (a.URITemplate = l.URITemplate.noConflict()), l.IPv6 && "function" === typeof l.IPv6.noConflict && (a.IPv6 = l.IPv6.noConflict()), l.SecondLevelDomains && "function" === typeof l.SecondLevelDomains.noConflict && (a.SecondLevelDomains = l.SecondLevelDomains.noConflict()), a;
                l.URI === this && (l.URI = G);
                return this
            };e.build = function(a) {
            ...
            };e.protocol = x("protocol");e.username = x("username");e.password = x("password");e.hostname = x("hostname");e.port = x("port");e.query = E("query", "?");e.fragment = E("fragment", "#");e.search = function(a, b) {
                ...
                if ("string" === typeof a || a instanceof String) this._parts = d.parse(String(a), this._parts);
                    ...
                    for (c in f = f ? a._parts : a, f) q.call(this._parts, c) && (this._parts[c] = f[c]);
                ...
                var b = !1,
                    ...
                    h = !1,
                    l = !this._parts.urn;
                this._parts.hostname && (l = !1, c = d.ip4_expression.test(this._parts.hostname),
                    f = d.ip6_expression.test(this._parts.hostname), b = c || f, k = (e = !b) && u && u.has(this._parts.hostname), m = e && d.idn_expression.test(this._parts.hostname), h = e && d.punycode_expression.test(this._parts.hostname));
            ...
            var H = e.protocol,
                I = e.port,
                J = e.hostname;e.protocol = function(a, b) {
                ...
                if (void 0 === a) {
                    ...
                    return !0 !== b && u && u.list[c.toLowerCase()] ? u.get(this._parts.hostname) ||
                        c : c
                }
                if (a)
            ...
            function(a, b) {
                ...
                if (h(b))
                    for (e =
                        0, g = b.length; e < g; e++) b[e] = d.decode(b[e]);
            ...
            var K = e.query;e.query = function(a, b) {
                ...
                for (;;) {
                    ...
                    b = b.substring(0, k) + b.substring(g + 3)
                }
                ...
                "string" === typeof this._parts.query && (this._parts.query.length ? this.query(d.parseQuery(this._parts.query,
                    this._parts.escapeQuerySpace)) : this._parts.query = null, this.build(!a));
                return this
                ...
                a._parts.hostname && (a.is("punycode") && p ? (b += p.toUnicode(a._parts.hostname), a._parts.port && (b += ":" + a._parts.port)) : b += a.host());
                a._parts.hostname && a._parts.path && "/" !== a._parts.path.charAt(0) && (b += "/");
                b += a.path(!0);
                if (a._parts.query) {
                    for (var c = "", e = 0, g = a._parts.query.split("&"), k = g.length; e < k; e++) {
                        var h = (g[e] || "").split("="),
                            c = c + ("&" + d.decodeQuery(h[0],
                ...
                "/" !== b.path().charAt(0) && (c = (c = a.directory()) ? c : 0 === a.path().indexOf("/") ? "/" : "", b._parts.path = (c ? c + "/" : "") + b._parts.path, b.normalizePath());
                b.build();
                return b
                ...
                if ("/" !== h.charAt(0)) throw Error("Cannot calculate a URI relative to another relative URI");
